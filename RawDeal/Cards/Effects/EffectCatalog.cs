...
public class EffectCatalog
{
    ...
    private EffectCatalog()
    {
        ...
        effects["Chop"] = new EffectCollection { new NoEffect() };
        // TODO : When successfully played, discard 1 card of your choice from your hand. 
        effects["Head Butt"] = new EffectCollection { new NoEffect() };
        ...
        effects["Kick"] = new EffectCollection { new NoEffect() };
        ...
        // TODO : When successfully played, you must take the top card of your Arsenal and put it into your Ringside pile. 
        effects["Running Elbow Smash"] = new EffectCollection { new NoEffect() };
        ...
        effects["Spinning Heel Kick"] = new EffectCollection { new NoEffect() };
        // TODO : May only reverse a maneuver played after the card titled Irish Whip. 
        ...
        // TODO : As an action, you may discard this card to draw 1 card. Doing this will not cause any damage to opponent. 
        effects["Arm Bar Takedown"] = new EffectCollection { new NoEffect() };
        // TODO : When successfully played, discard 1 card of your choice from your hand. 
        effects["Arm Drag"] = new EffectCollection { new NoEffect() };
        ...
        effects["Double Leg Takedown"] = new EffectCollection { new NoEffect() };
        ...
        effects["Headlock Takedown"] = new EffectCollection { new NoEffect() };
        ...
        effects["Pump Handle Slam"] = new EffectCollection { new NoEffect() };
        // TODO : When successfully played, you may draw 1 card. 
        effects["Reverse DDT"] = new EffectCollection { new NoEffect() };
        // TODO : When successfully played, opponent must discard 1 card. 
        effects["Samoan Drop"] = new EffectCollection { new NoEffect() };
        ...
        effects["Bulldog"] = new EffectCollection { new NoEffect() };
        ...
        effects["Fisherman's Suplex"] = new EffectCollection { new NoEffect() };
        ...
        effects["DDT"] = new EffectCollection { new NoEffect() };
        // TODO : When successfully played, opponent must discard 1 card. 
        effects["Power Slam"] = new EffectCollection { new NoEffect() };
        ...
        // TODO : When successfully played, you must take the top card of your Arsenal and put it into your Ringside pile. Opponent must discard 2 cards. 
        effects["Press Slam"] = new EffectCollection { new NoEffect() };
        // TODO : As an action, you may discard this card to draw 1 card. Doing this will not cause any damage to opponent. 
        effects["Collar & Elbow Lockup"] = new EffectCollection { new NoEffect() };
        // TODO : When successfully played, discard 1 card of your choice from your hand. 
        effects["Arm Bar"] = new EffectCollection { new NoEffect() };
        // TODO : When successfully played, opponent must discard 1 card. 
        effects["Bear Hug"] = new EffectCollection { new NoEffect() };
        ...
        // TODO : When successfully played, opponent must discard 1 card. 
        effects["Choke Hold"] = new EffectCollection { new NoEffect() };
        // TODO : When successfully played, opponent must discard 1 card. 
        effects["Ankle Lock"] = new EffectCollection { new NoEffect() };
        // TODO : When successfully played, opponent must draw 1 card. 
        effects["Standing Side Headlock"] = new EffectCollection { new NoEffect() };
        // TODO : When successfully played, look through your Arsenal for the card titled Maintain Hold and place that card in your hand, then shuffle your Arsenal. 
        ...
        // TODO : When successfully played, opponent must discard 1 card. 
        effects["Torture Rack"] = new EffectCollection { new NoEffect() };
        // TODO : When successfully played, opponent must discard 1 card. 
        effects["Figure Four Leg Lock"] = new EffectCollection { new NoEffect() };
        ...
        effects["Clean Break"] = new EffectCollection { new DiscardEffect(4), new DrawEffect(1) };
        // Reverse any maneuver and end your opponent's turn. If played from your hand draw 1 card. 
        effects["Manager Interferes"] = new EffectCollection { new DrawEffect(1) };
        ...
        effects["Jockeying for Position"] = new EffectCollection { new NoEffect() };
        ...
        effects["Irish Whip"] = new EffectCollection { new NoEffect() };
        ...
        effects["Offer Handshake"] = new EffectCollection { new NoEffect() };
        ...
        effects["Recovery"] = new EffectCollection { new NoEffect() };
        ...
        effects["Spit At Opponent"] = new EffectCollection { new NoEffect() };
        ...
        effects["Puppies! Puppies!"] = new EffectCollection { new NoEffect() };
        ...
        effects["Undertaker's Tombstone Piledriver"] = new EffectCollection { new NoEffect() };
        ...
        effects["Tree of Woe"] = new EffectCollection { new NoEffect() };
        ...
        effects["Chyna Interferes"] = new EffectCollection { new DrawEffect(2) };
        ...
        effects["Lionsault"] = new EffectCollection { new NoEffect() };
