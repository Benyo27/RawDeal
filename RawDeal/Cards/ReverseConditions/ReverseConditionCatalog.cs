...
public class ReverseConditionCatalog
{
    ...
    public List<ICondition> GetConditions(string cardTitle)
    {
        ...
        {
            return new List<ICondition> { new NoReverse() };
        }
    ...
    private ReverseConditionCatalog()
    {
        ...
        conditions["Cross Body Block"] = new List<ICondition> { new NoReverse() };
        // TODO : May only reverse the maneuver titled Kick. 
        conditions["Ensugiri"] = new List<ICondition> { new NoReverse() };
        // TODO : When successfully played, you must take the top card of your Arsenal and put it into your Ringside pile. 
        conditions["Running Elbow Smash"] = new List<ICondition> { new NoReverse() };
        // TODO : May only reverse the maneuver titled Drop Kick. 
        conditions["Drop Kick"] = new List<ICondition> { new NoReverse() };
        // TODO : Reversals to this maneuver are +2D. 
        conditions["Discus Punch"] = new List<ICondition> { new NoReverse() };
        // TODO : When successfully played, +5D if played after a 5D or greater maneuver. 
        conditions["Superkick"] = new List<ICondition> { new NoReverse() };
        // TODO : When successfully played, opponent must discard 1 card. 
        conditions["Spinning Heel Kick"] = new List<ICondition> { new NoReverse() };
        // TODO : May only reverse a maneuver played after the card titled Irish Whip. 
        conditions["Spear"] = new List<ICondition> { new NoReverse() };
        // TODO : When successfully played, if your next card played this turn is a maneuver it is +2D. 
        conditions["Clothesline"] = new List<ICondition> { new NoReverse() };
        // TODO : As an action, you may discard this card to draw 1 card. Doing this will not cause any damage to opponent. 
        conditions["Arm Bar Takedown"] = new List<ICondition> { new NoReverse() };
        // TODO : When successfully played, discard 1 card of your choice from your hand. 
        conditions["Arm Drag"] = new List<ICondition> { new NoReverse() };
        // TODO : When successfully played, if your next card played this turn is a Strike maneuver it is +2D. 
        conditions["Snap Mare"] = new List<ICondition> { new NoReverse() };
        // TODO : When successfully played, you may draw 1 card. 
        conditions["Double Leg Takedown"] = new List<ICondition> { new NoReverse() };
        // TODO : When successfully played, you may look at your opponent's hand. 
        conditions["Fireman's Carry"] = new List<ICondition> { new NoReverse() };
        // TODO : When successfully played, opponent must draw 1 card. 
        conditions["Headlock Takedown"] = new List<ICondition> { new NoReverse() };
        // TODO : May only reverse the maneuver titled Belly to Belly Suplex. 
        conditions["Belly to Belly Suplex"] = new List<ICondition> { new NoReverse() };
        // TODO : When successfully played, if your next card played this turn is a maneuver it is +2D. 
        conditions["Atomic Drop"] = new List<ICondition> { new NoReverse() };
        // TODO : May only reverse the maneuver titled Vertical Suplex. 
        conditions["Vertical Suplex"] = new List<ICondition> { new NoReverse() };
        // TODO : May only reverse the maneuver titled Belly to Back Suplex. 
        conditions["Belly to Back Suplex"] = new List<ICondition> { new NoReverse() };
        // TODO : When successfully played, opponent must discard 2 cards. 
        conditions["Pump Handle Slam"] = new List<ICondition> { new NoReverse() };
        // TODO : When successfully played, you may draw 1 card. 
        conditions["Reverse DDT"] = new List<ICondition> { new NoReverse() };
        // TODO : When successfully played, opponent must discard 1 card. 
        conditions["Samoan Drop"] = new List<ICondition> { new NoReverse() };
        ...
        conditions["Bulldog"] = new List<ICondition> { new NoReverse() };
        ...
        conditions["Fisherman's Suplex"] = new List<ICondition> { new NoReverse() };
        ...
        conditions["DDT"] = new List<ICondition> { new NoReverse() };
        // TODO : When successfully played, opponent must discard 1 card. 
        conditions["Power Slam"] = new List<ICondition> { new NoReverse() };
        ...
        conditions["Powerbomb"] = new List<ICondition> { new NoReverse() };
        // TODO : When successfully played, you must take the top card of your Arsenal and put it into your Ringside pile. Opponent must discard 2 cards. 
        conditions["Press Slam"] = new List<ICondition> { new NoReverse() };
        // TODO : As an action, you may discard this card to draw 1 card. Doing this will not cause any damage to opponent. 
        conditions["Collar & Elbow Lockup"] = new List<ICondition> { new NoReverse() };
        // TODO : When successfully played, discard 1 card of your choice from your hand. 
        conditions["Arm Bar"] = new List<ICondition> { new NoReverse() };
        // TODO : When successfully played, opponent must discard 1 card. 
        conditions["Bear Hug"] = new List<ICondition> { new NoReverse() };
        ...
        conditions["Full Nelson"] = new List<ICondition> { new NoReverse() };
        // TODO : When successfully played, opponent must discard 1 card. 
        conditions["Choke Hold"] = new List<ICondition> { new NoReverse() };
        // TODO : When successfully played, opponent must discard 1 card. 
        conditions["Ankle Lock"] = new List<ICondition> { new NoReverse() };
        // TODO : When successfully played, opponent must draw 1 card. 
        conditions["Standing Side Headlock"] = new List<ICondition> { new NoReverse() };
        // TODO : When successfully played, look through your Arsenal for the card titled Maintain Hold and place that card in your hand, then shuffle your Arsenal. 
        conditions["Cobra Clutch"] = new List<ICondition> { new NoReverse() };
        // TODO : When successfully played, shuffle 2 cards from your Ringside pile into your Arsenal. 
        conditions["Chicken Wing"] = new List<ICondition> { new NoReverse() };
        // TODO : When successfully played, look through your Arsenal for the card titled Maintain Hold and place that card in your hand, then shuffle your Arsenal. 
        conditions["Sleeper"] = new List<ICondition> { new NoReverse() };
        // TODO : When successfully played, look through your Arsenal for the card titled Maintain Hold and place that card in your hand, then shuffle your Arsenal. 
        conditions["Camel Clutch"] = new List<ICondition> { new NoReverse() };
        // TODO : When successfully played, opponent must discard 1 card. 
        conditions["Boston Crab"] = new List<ICondition> { new NoReverse() };
        // TODO : When successfully played, opponent must discard 1 card and you may draw 1 card. 
        conditions["Guillotine Stretch"] = new List<ICondition> { new NoReverse() };
        ...
        conditions["Abdominal Stretch"] = new List<ICondition> { new NoReverse() };
        // TODO : When successfully played, opponent must discard 1 card. 
        conditions["Torture Rack"] = new List<ICondition> { new NoReverse() };
        // TODO : When successfully played, opponent must discard 1 card. 
        conditions["Figure Four Leg Lock"] = new List<ICondition> { new NoReverse() };
        // Reverse any Strike maneuver and end your opponent's turn. 
        conditions["Step Aside"] = new List<ICondition> { new AnyManeuver("Strike", false) };
        // Reverse any Grapple maneuver and end your opponent's turn. 
        conditions["Escape Move"] = new List<ICondition> { new AnyManeuver("Grapple", false) };
        // Reverse any Submission maneuver and end your opponent's turn. 
        conditions["Break the Hold"] = new List<ICondition> { new AnyManeuver("Submission", false) };
        ...
        conditions["Rolling Takedown"] = new List<ICondition> { new AnyManeuver("Grapple", true) };
        ...
        conditions["Knee to the Gut"] = new List<ICondition> { new AnyManeuver("Strike", true) };
        // May reverse any maneuver that does 7D or less. End your opponent's turn. 
        conditions["Elbow to the Face"] = new List<ICondition> { new AnyManeuver("any", true) };
        ...
        conditions["Manager Interferes"] = new List<ICondition> { new AnyManeuver("any", false) };
        ...
        conditions["Disqualification!"] = new List<ICondition> { new NoReverse() };
        ...
        conditions["Hmmm"] = new List<ICondition> { new NoReverse() };
        ...
        conditions["Don't Think Too Hard"] = new List<ICondition> { new NoReverse() };
        // TODO : Look at opponent's hand. 
        conditions["Whaddya Got?"] = new List<ICondition> { new NoReverse() };
        // TODO : Take a card in your hand, shuffle it into your Arsenal, then draw 2 cards. 
        conditions["Not Yet"] = new List<ICondition> { new NoReverse() };
        ...
        conditions["Irish Whip"] = new List<ICondition> { new NoReverse() };
        // TODO : Draw 1 card. Look at opponent's hand, and then make him discard all HEEL cards. 
        conditions["Flash in the Pan"] = new List<ICondition> { new NoReverse() };
        // TODO : Draw 1 card. Look at opponent's hand, and then make him discard all FACE cards. 
        conditions["View of Villainy"] = new List<ICondition> { new NoReverse() };
        ...
        conditions["Shake It Off"] = new List<ICondition> { new NoReverse() };
        // TODO : Draw up to 3 cards, then discard 1 card. 
        conditions["Offer Handshake"] = new List<ICondition> { new NoReverse() };
        ...
        conditions["Spit At Opponent"] = new List<ICondition> { new NoReverse() };
        // TODO : Draw 1 card. Your next maneuver this turn is +4D and opponent's reversals are +12F. 
        conditions["Get Crowd Support"] = new List<ICondition> { new NoReverse() };
        ...
        conditions["Comeback!"] = new List<ICondition> { new NoReverse() };
        ...
        conditions["Ego Boost"] = new List<ICondition> { new NoReverse() };
        // TODO : Draw 4 cards. At end of turn, discard your hand. 
        conditions["Deluding Yourself"] = new List<ICondition> { new NoReverse() };
        ...
        conditions["Stagger"] = new List<ICondition> { new NoReverse() };
        // TODO : Your next maneuver may not be reversed. 
        conditions["Diversion"] = new List<ICondition> { new NoReverse() };
        ...
        conditions["Marking Out"] = new List<ICondition> { new NoReverse() };
        // TODO : Shuffle up to 5 cards from your Ringside pile into your Arsenal. Then draw 2 cards. 
        conditions["Puppies! Puppies!"] = new List<ICondition> { new NoReverse() };
        ...
        conditions["Shane O'Mac"] = new List<ICondition> { new NoReverse() };
        ...
        conditions["Maintain Hold"] = new List<ICondition> { new NoReverse() };
        // TODO : Opponent skips his next turn. 
        conditions["Pat & Gerry"] = new List<ICondition> { new NoReverse() };
        // TODO : May not be reversed. Can only be played after a maneuver that does 5D or greater. 
        conditions["Austin Elbow Smash"] = new List<ICondition> { new NoReverse() };
        ...
        conditions["Lou Thesz Press"] = new List<ICondition> { new NoReverse() };
        ...
        conditions["Double Digits"] = new List<ICondition> { new NoReverse() };
        // TODO : -6F on this card if played after the maneuver titled Kick. 
        conditions["Stone Cold Stunner"] = new List<ICondition> { new NoReverse() };
        // TODO : Your next maneuver this turn is +6D, and your opponent's reversal to it is +20F. Draw a card. 
        conditions["Open Up a Can of Whoop-A%$"] = new List<ICondition> { new NoReverse() };
        // TODO : Can only be played after a 5D or greater maneuver. Reversals to this maneuver are +6D. 
        conditions["Undertaker's Flying Clothesline"] = new List<ICondition> { new NoReverse() };
        ...
        conditions["Undertaker Sits Up!"] = new List<ICondition> { new NoReverse() };
        // TODO : As an action, this card is -30F and -25D, discard this card and draw 1 card. 
        conditions["Undertaker's Tombstone Piledriver"] = new List<ICondition> { new NoReverse() };
        // TODO : +5D to all your maneuvers and +20F to all of opponent's reversals for the rest of this turn. 
        conditions["Power of Darkness"] = new List<ICondition> { new NoReverse() };
        ...
        conditions["Have a Nice Day!"] = new List<ICondition> { new NoReverse() };
        // TODO : May only reverse the maneuver titled Back Body Drop. 
        conditions["Double Arm DDT"] = new List<ICondition> { new NoReverse() };
        // TODO : May not be reversed. When successfully played, opponent must discard 2 cards. 
        conditions["Tree of Woe"] = new List<ICondition> { new NoReverse() };
        ...
        conditions["Mandible Claw"] = new List<ICondition> { new NoReverse() };
        ...
        conditions["Mr. Socko"] = new List<ICondition> { new NoReverse() };
        ...
        conditions["Leaping Knee to the Face"] = new List<ICondition> { new NoReverse() };
        ...
        conditions["Take That Move, Shine It Up Real Nice, Turn That Sumb*tch Sideways, and Stick It Straight Up Your Roody Poo Candy A%$!"] = new List<ICondition> { new NoReverse() };
        ...
        conditions["Rock Bottom"] = new List<ICondition> { new NoReverse() };
        ...
        conditions["The People's Eyebrow"] = new List<ICondition> { new NoReverse() };
        ...
        conditions["The People's Elbow"] = new List<ICondition> { new NoReverse() };
        // TODO : Can only be played after a 4D or greater maneuver. Reversals to this maneuver are +6D. 
        conditions["Kane's Flying Clothesline"] = new List<ICondition> { new NoReverse() };
        ...
        conditions["Kane's Return!"] = new List<ICondition> { new NoReverse() };
        // TODO : -6F on this card if played after the card titled Kane's Choke Slam. 
        conditions["Kane's Tombstone Piledriver"] = new List<ICondition> { new NoReverse() };
        ...
        conditions["Don't You Never... EVER!"] = new List<ICondition> { new NoReverse() };
        // TODO : You may play the card titled Maintain Hold after this card as if it were a Submission maneuver. 
        conditions["Walls of Jericho"] = new List<ICondition> { new NoReverse() };
        ...
        conditions["Ayatollah of Rock 'n' Roll-a"] = new List<ICondition> { new NoReverse() };
    }
}